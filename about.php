    ...
    <div class="row m-v-0">
      <div id="programming" class="col s12 m-v-4 section scrollspy">
            ...
            <?php
              ...
              generateSkill("C#", 70, "progress-programming", "Sorting Visualiser, Delivery Route Planner.", "Confident (2 projects)");
              generateSkill("Python", 65, "progress-programming", "Machine learning projects.", "Comfortable (1 projects)");
              generateSkill("C++", 65, "progress-programming", "OpenGL simulation of a roller coaster.", "Comfortable (1 project)");
              generateSkill("C", 30, "progress-programming", "Basic knowledge. 3D-Printing algorithms for 2D and 3D Shapes.", "Beginner (2 project)");
    ...
    <div class="row m-v-0">
      <div id="web" class="col s12 m-v-4 section scrollspy">
        ...
        <?php
          ...
          generateSkill("Less", 35, "progress-web", "Used for styling in a React project.", "Beginner (1 project)");
        ...
        <?php
          ...
          generateSkill("jQuery", 55, "progress-web", "Used for CS139 coursework.", "Comfortable (5 projects)");
          generateSkill("Bootstrap", 65, "progress-web", "Used in a previous version of this website, CS139 coursework.", "Comfortable (2 projects)");
          generateSkill("Materialize", 75, "progress-web", "Used in this version of this website.", "Comfortable (2 projects)");
          generateSkill("Webix", 70, "progress-web", "Used to create UI in intern project at Bank of America Merrill Lynch.", "Comfortable (1 project)");
          generateSkill("React", 10, "progress-web", "React Hooks used in intern project at Bank of America Merrill Lynch.", "Beginner (1 project)");
        ?>
      </div>
    </div>
  </div>
  ...
  <div class="container m-v-0">
    <div class="row m-v-0">
      <div id="modules" class="col s12 m-v-4 section scrollspy">
        ...
        <ul>
          <li>CS241: Operating Systems and Computer Networks<i class="material-icons icon-arrow">arrow_forward</i><a class="project-link" href="projects/#cs241">Multi-Threaded Packet Sniffer</a></li>
          <li>CS256: Functional Programming<i class="material-icons icon-arrow">arrow_forward</i><a class="project-link" href="projects/mastermind.php">Mastermind Coursework</a>, <a class="project-link" href="projects/#scratch-clone">Scratch Clone Coursework</a></li>
          ...
          <li>CS261: Software Engineering<i class="material-icons icon-arrow">arrow_forward</i><a class="project-link" href="projects/rscbot.php">Trader ChatBot Group Project</a></li>
          <li>CS262: Logic and Verification<i class="material-icons icon-arrow">arrow_forward</i><span class="project-link">Alloy Coursework</span></li>
          <li>CS263: Cyber Security<i class="material-icons icon-arrow">arrow_forward</i><span class="project-link">Wondough Bank Coursework</span></li>
        </ul>
        <br>
        <h5>Year 3 Modules</h5>
        <ul>
          <li>CS310: Computer Science Project (Dissertation)<i class="material-icons icon-arrow">arrow_forward</i><span class="project-link">Using Swarm AI to map a cave network</a></li>
          <li>CS313: Mobile Robotics</li>
          <li>CS324: Computer Graphics<i class="material-icons icon-arrow">arrow_forward</i><a class="project-link" href="projects/#roller-coaster">OpenGL Roller coaster</a></li>
