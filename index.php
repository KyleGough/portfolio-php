...
<div class="col-light-blue">
  <div class="container">
    <div class="row center m-v-0">
      ...
      ?>
      <div class="col s12 l6 m-v-4 p-h-2">
        <?php
          echo "<div class='responsive-frame'><span class='responsive-helper'></span>";
          echo "<img class='responsive-img1 light-border z-depth-1' src='" . $featuredProject["image"] . "' alt='" . $featuredProject["alt"] . "' height=350px></div>"
        ?>
      </div>
      <div class="col s12 l6 m-v-4">
...
<div class="col-light-red">
  <div class="container">
    <div class="row center m-v-0">
      ...
      <?php
        echo "<div class='responsive-frame'><span class='responsive-helper'></span>";
        echo "<img class='responsive-img1 light-border z-depth-1' src='" . $latestProject["image"] . "' alt='" . $latestProject["alt"] . "' height:350px></div>";
      ?>
      </div>
    </div>
  </div>
