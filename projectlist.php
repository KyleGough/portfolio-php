  ...
  <div id="no-matches" class="container m-v-0">
    <div class="row m-t-2">
      <div class="col s12 section scrollspy center">
        <h3>No Matches</h3>
        <p>Unfortunately no projects matched the search, to see all of my projects <a class="project-link" href="projectlist.php">click here.</a></p>
    ...
    <div class="row m-v-4">
      <div class="col s4 offset-s2 center">
        <ul>
          <li><a class="project-link" href="projectlist.php?lan=java">Java</a></li>
          <li><a class="project-link" href="projectlist.php?lan=js">JavaScript</a></li>
          <li><a class="project-link" href="projectlist.php?lan=csharp">C#</a></li>
          <li><a class="project-link" href="projectlist.php?lan=ruby">Ruby</a></li>
          <li><a class="project-link" href="projectlist.php?lan=bash">Bash</a></li>
          <li><a class="project-link" href="projectlist.php?lan=jquery">jQuery</a></li>
          <li><a class="project-link" href="projectlist.php?lan=sass">Sass</a></li>
        </ul>
      </div>
      <div class="col s4 center">
        <ul>
          <li><a class="project-link" href="projectlist.php?lan=html">HTML</a></li>
          <li><a class="project-link" href="projectlist.php?lan=css">CSS</a></li>
          <li><a class="project-link" href="projectlist.php?lan=sql">SQL</a></li>
          <li><a class="project-link" href="projectlist.php?lan=php">PHP</a></li>
          <li><a class="project-link" href="projectlist.php?lan=c">C</a></li>
          <li><a class="project-link" href="projectlist.php?lan=bootstrap">Bootstrap</a></li>
          <li><a class="project-link" href="projectlist.php?lan=materialize">Materialize</a></li>
        </ul>
      </div>
    </div>
  </div>
